...
EN = {
    "direct_source": "Source image",
    "direct_original": "Original",
    "direct_result": "NR result",
    "direct_enhance": "Enhance image",
    "direct_cancel": "Cancel",
    "direct_status": "Task status",
    "direct_receipt": "Execution receipt",
    "direct_stage": "Uploaded image",
    "direct_ready_gpu": "Ready: {gpu}.",
    "direct_prepared": "NR runtime files are ready.",
    "direct_saved": "Preset saved.",
    "direct_loaded": "Preset loaded.",
    "direct_reset": " Runs on the uploaded image.",
    "direct_running": "NR processing...",
    "direct_done": "Completed: {width} x {height}, {passes} NR pass(es).",
    "direct_canceling": "Cancellation requested; waiting for this NR job to stop.",
    "direct_canceled": "Canceled. No result was accepted.",
    "direct_session": "Reload this page before starting an NR job.",
    "direct_closed": "This NR page has been unloaded. Reload Forge when it is idle.",
    "direct_busy": "This page already has an active NR job.",
    "direct_no_pass": "Enable at least one NR parameter tab.",
    "direct_no_image": "Upload a still image first.",
    "direct_image_format": "Use an 8-bit still image; animated images and HDR are not supported.",
    "direct_image_size": "Image is too large: maximum edge 8192 pixels and maximum area 32 megapixels.",
    "direct_color_profile": "The image's color profile could not be converted to sRGB.",
    "direct_failed": "No result accepted: {error}",
    "direct_unknown": "Execution state is unknown; temporary files are retained. {error}",
    "enable_pass": "Enable this tab ({index})",
    "copy_previous": "Copy previous tab parameters",
    "stage": "Insertion point",
    "before_hr": "Before Hires. fix (after first pass if Hires is off)",
    "after_hr": "After Hires. fix",
    "after_img2img": "After img2img",
    "behavior": "Enabled tabs run in tab order within each insertion point: before Hires, then after Hires. All run before face restoration / ADetailer. Failure stops generation; no automatic GPU switching or unloading of other models.",
    "behavior_img2img": "Enabled tabs run in order after img2img sampling and latent callbacks, before face restoration / ADetailer and mask compositing. Internal redraws do not run NR again. Source images and denoising strength are unchanged; failure stops generation.",
    ...
    "skin": "Skin structure",
    "mix": "Output blend (0 = this pass input, 1 = NR; the model still runs)",
    ...
    "preset_scope": "Presets store all three tabs, including their switches and insertion points. The master switch, GPU and runtime are unchanged. Saving the same name replaces it.",
    "saved": "Saved preset",
    ...
    "preset_picker": "Preset",
    "preset_state_saved": "Saved",
    "preset_state_modified": "Modified (not saved)",
    "preset_state_new": "Not saved",
    "confirm_overwrite": "Replace preset \"{name}\"?",
    "confirm_delete": "Delete preset \"{name}\"?",
    "presets_unchanged": "Presets unchanged.",
    "refresh_presets": "Refresh preset list",
    "presets_refreshed": "Preset list refreshed.",
    ...
    "saved_ok": "Preset saved.",
    "save_failed": "Save failed: {error}",
    "loaded_ok": "Preset loaded.",
    "hires_reset": " Insertion reset to before Hires. fix.",
    "img2img_reset": " All tabs run after img2img.",
    "load_failed": "Load failed: {error}",
    "deleted_ok": "Preset deleted. Parameters unchanged.",
...
ZH = {
    ...
    "direct_receipt": "执行回执",
    "direct_stage": "上传图片",
    "direct_ready_gpu": "已就绪：{gpu}。",
    "direct_prepared": "NR运行库文件已就绪。",
    "direct_saved": "预设已保存。",
    "direct_loaded": "预设已载入。",
    "direct_reset": " 各页直接处理上传图片。",
    "direct_running": "NR处理中...",
    "direct_done": "已完成：{width} x {height}，{passes}遍NR。",
    "direct_canceling": "已请求取消，正在等待本次NR任务停止。",
    "direct_canceled": "已取消，未接收结果。",
    "direct_session": "请刷新本页面后再开始NR任务。",
    "direct_closed": "本NR页面已卸载，请在空闲时重载Forge。",
    "direct_busy": "本页面已有NR任务正在执行。",
    "direct_no_pass": "请至少启用一页NR参数。",
    "direct_no_image": "请先上传一张静态图片。",
    "direct_image_format": "请选择8位静态图片；不支持动画或HDR。",
    "direct_image_size": "图片超过限制：最长边8192像素、面积不超过32兆像素。",
    "direct_color_profile": "无法将图片内嵌颜色配置转换为sRGB。",
    "direct_failed": "未接收结果：{error}",
    "direct_unknown": "执行状态未知，已保留临时文件。{error}",
    "enable_pass": "启用此页（第{index}页）",
    "copy_previous": "复制上一页参数",
    "stage": "插入时机",
    "before_hr": "高清修复前（未开高清：首轮后）",
    "after_hr": "高清修复后",
    "after_img2img": "图生图后",
    "behavior": "已启用页按阶段执行：先高清前，再高清后，各阶段内按页序。均在修脸/ADetailer前完成；失败中止生成，不自动换卡或卸载其他模型。",
    "behavior_img2img": "已启用页在图生图采样及latent回调后按页序执行，位于修脸/ADetailer及蒙版回贴之前。内部重绘不重复运行NR；不改输入原图或重绘幅度，失败中止生成。",
    "style": "风格编号（0-2）",
    "preset": "模型内部档位（0-3）",
    "intensity": "模型强度",
    "tone": "色调",
    "structure": "结构",
    "skin": "皮肤",
    "mix": "本页混合（0=本页输入，1=纯NR；仍执行模型）",
    "auto_mask": "自动蒙版",
    "flow": "时序光流（单图不使用）",
    "experimental": "模型控制项仍属实验性，不代表已校准的质量等级。皮肤默认-1，每张静图重置时序历史。",
    "presets": "本地命名参数预设",
    "preset_scope": "保存整组三页的开关、参数与插入时机，不保存总开关/显卡/环境。保存同名会覆盖；删除只删该条预设。",
    "saved": "已保存预设",
    "load": "载入参数",
    "delete": "删除选中预设",
    "name": "预设名",
    ...
    "preset_status": "预设状态",
    "preset_picker": "预设",
    "preset_state_saved": "已保存",
    "preset_state_modified": "已修改 · 未保存",
    "preset_state_new": "未保存",
    "confirm_overwrite": "覆盖预设「{name}」？",
    "confirm_delete": "删除预设「{name}」？",
    "presets_unchanged": "预设未改动。",
    "refresh_presets": "刷新预设列表",
    "presets_refreshed": "预设列表已刷新。",
    ...
    "loaded_ok": "预设已载入。",
    "hires_reset": " 插入时机已设为高清前。",
    "img2img_reset": " 各页在图生图后执行。",
    "load_failed": "载入失败：{error}",
    "deleted_ok": "预设已删除，参数不变。",
