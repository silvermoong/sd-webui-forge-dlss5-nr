...
EN = {
    ...
    "saved_ok": "All three tabs saved. Master switch and runtime were not saved.",
    "save_failed": "Save failed: {error}",
    "loaded_ok": "Tabs loaded. Master switch and runtime are unchanged.",
...
ZH = {
    ...
    "saved_ok": "已保存整组三页；总开关和环境未保存。",
    "save_failed": "保存失败：{error}",
    "loaded_ok": "已载入三页设置；总开关与环境不变。",
